...
def generate_launch_description():
    ...
    oanode = Node(
    package='object_analytics_node', executable='object_analytics_node', name='object_analytics_node',
    ...
    # Object Search Node
    searchnode = Node(
    package='kmr_manipulator', executable='object_detection_node.py', name='object_detection_node',
    output='screen',
    emulate_tty=True,
    )
   ...
   # Gripper node:
    ...
    oarviz2 = Node(
    package='object_analytics_rviz', executable='marker_publisher',)
    #output='screen')
